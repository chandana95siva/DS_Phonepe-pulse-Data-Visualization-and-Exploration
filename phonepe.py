...
if selected == "HOME":
    image = Image.open('phonepe-graphic.png')
    st.image(image)    
...
if selected == "ANALYSIS":
    ...
    if option == 'All India':
        st.sidebar.title("All India Analysis using Map")
        option = st.sidebar.radio("Select Analysis Option", ["Transaction", "User"])
    ...
    #         ------  Geo visualization dashboard for Transaction ---- #
            ...
            fig_transaction.update_layout(title_font=dict(size=33),title_font_color='#42e6f5', height=800)
            ...
            df_in_tr_tab_qry_rslt1_fig.update_layout(title_font=dict(size=33),title_font_color='#42e6f5')
            st.plotly_chart(df_in_tr_tab_qry_rslt1_fig,use_container_width=True)

    #         # -------All India Total Transaction calculation Table ----  #
            st.header(':green[Total calculation]')
...
#     # -----------------------All India User -------------------------- #
    ...
    #         # Total User Count table query
            ...
            fig_use.update_layout(title_font=dict(size=33),title_font_color='#42e6f5', height=800)
            ...
            df_in_us_tab_qry_rslt1_fig.update_layout(title_font=dict(size=33),title_font_color='#42e6f5')
    ...
    # -----    /   State wise Transaction Analysis bar chart   /   ------ #
            ...
            df_st_tr_tab_bar_qry_rslt1_fig.update_layout(title_font=dict(size=33),title_font_color='#42e6f5')
        ...
        # -------------/ State wise User/--------------- # 
            ...
            df_st_us_tab_qry_rslt1_fig.update_layout(title_font=dict(size=33),title_font_color='#42e6f5')
    ...
    # # =================Top Transaction==================== #
        ...
        # --------------All India Top Transaction-------------- #
            ...
            df_top_tr_tab_qry_rslt1_fig.update_layout(title_font=dict(size=33),title_font_color='#42e6f5')
    ...
    # -------------------------       /     All India Top User        /        ------------------ #
            with tab6:
                ...
                df_top_us_tab_qry_rslt1_fig.update_layout(title_font=dict(size=33),title_font_color='#42e6f5')
